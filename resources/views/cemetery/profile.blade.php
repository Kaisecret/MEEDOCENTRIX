...
<div data-server-rendered-page="profile" data-page-title="My Profile" class="fp-profile">
    ...
    <div class="fp-card">
        ...
        <div class="fp-card-body">
            <form action="{{ route('cemetery.profile.update') }}" method="POST">
                @csrf
                @method('PUT')
    ...
    <div class="fp-card">
        ...
        <div class="fp-card-body">
            <form action="{{ route('cemetery.profile.update') }}" method="POST">
                ...
                <div class="fp-grid">
                    <div class="fp-field">
                        <label for="cmp-name">Full Name</label>
                        <input id="cmp-name" name="name" type="text" class="fp-input" value="{{ old('name', $user->name) }}" required>
                    </div>
                    <div class="fp-field">
                        <label for="cmp-username">Username</label>
                        <input id="cmp-username" name="username" type="text" class="fp-input" value="{{ old('username', $user->username) }}" autocomplete="off">
                    </div>
                    <div class="fp-field">
                        <label for="cmp-email">Email Address</label>
                        <input id="cmp-email" name="email" type="email" class="fp-input" value="{{ old('email', $user->email) }}" required>
                    </div>
                    <div class="fp-field">
