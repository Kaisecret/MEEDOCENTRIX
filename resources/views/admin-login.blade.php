...
<head>
    ...
    <title>Admin Login | Meedocentrix</title>
    ...
    <style>
        ...
        .login-wrapper {
            ...
            /* FIX 1: Make wrapper a flex column */
            display: flex;
            flex-direction: column; 
            overflow: hidden;
        }

        /* FIX 2: Tell the inner row to grow and fill the entire wrapper */
        .login-wrapper > .row {
            flex-grow: 1;
        }
        ...
        .transition-col {
            ...
            overflow: hidden; 
            /* FIX 3: Make it a column so children can grow inside it */
            display: flex; 
            flex-direction: column;
        }
        ...
        .right-panel {
            ...
            /* FIX 5: Use flex-grow instead of height: 100% */
            flex-grow: 1;
            width: 100%; 
...
<body class="d-flex align-items-start align-items-md-center justify-content-center min-vh-100 p-3">
    ...
    <div class="container login-wrapper p-0" id="mainWrapper">
        ...
        <div class="overlap-btn" id="togglePanelBtn" aria-label="Toggle left panel">
        ...
        <div class="row g-0 w-100 h-100 align-items-stretch">
            ...
            <div class="transition-col" id="leftCol">
                <div class="left-panel d-flex flex-column align-items-center justify-content-center text-center">
                    ...
                    <button class="btn btn-learn-more">Admin Access</button>
                </div>
            </div>
            ...
            <div class="transition-col" id="rightCol">
                <div class="right-panel d-flex flex-column justify-content-center">
                    ...
                    <div class="d-block d-lg-none text-center mb-4">
                        <img src="{{ asset('images/mobilelogo.png') }}" alt="Meedocentrix Logo" style="width: 220px; max-width: 72vw; height: auto; margin-bottom: 0.8rem; position: relative; z-index: 0; filter: drop-shadow(0 8px 16px rgba(0, 0, 0, 0.18));">
                    </div>

                    <div class="text-center mb-4">
                        <h2 class="fw-bold mb-2" style="color: var(--text-main);">Administrator Login</h2>
                        <p class="mb-3" style="color: var(--text-muted); font-size: 1.05rem;">Sign in with your administrator account to continue</p>
                    </div>
                    ...
                    <div class="auth-form-shell">
                        ...
                        <div class="d-grid mb-4">
                            <button type="submit" id="adminLoginBtn" class="btn btn-login py-3" data-loading-label="Signing in...">Admin Login</button>
                        </div>
                        </form>
                    </div>
    ...
    <script>
        ...
        if (adminLoginForm && adminLoginBtn) {
            const defaultLabel = adminLoginBtn.textContent.trim();
            const loadingLabel = adminLoginBtn.dataset.loadingLabel || 'Signing in...';

            adminLoginForm.addEventListener('submit', function(event) {
                if (adminLoginForm.dataset.submitting === '1') {
                    event.preventDefault();
                    return;
                }

                adminLoginForm.dataset.submitting = '1';
                adminLoginBtn.disabled = true;
                adminLoginBtn.classList.add('is-loading');
                adminLoginBtn.innerHTML = `<i class="fa-solid fa-spinner fa-spin"></i><span>${loadingLabel}</span>`;

                // Fallback: if submission is blocked by browser/network interruption, restore button.
                window.setTimeout(() => {
                    if (document.visibilityState === 'visible') {
                        adminLoginForm.dataset.submitting = '0';
                        adminLoginBtn.disabled = false;
                        adminLoginBtn.classList.remove('is-loading');
                        adminLoginBtn.textContent = defaultLabel;
                    }
                }, 12000);
            });
        }
