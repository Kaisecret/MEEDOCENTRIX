...
<body>
    <div class="sheet">
        <section class="head">
            <h1>Market Collector Transactions Report</h1>
            <div class="meta">
        ...
        <section class="grid">
            ...
            <div class="kpi"><span>Accepted / Pending</span><strong>{{ number_format($acceptedTransactions) }} / {{ number_format($pendingTransactions) }}</strong></div>
        ...
        <table>
            <thead>
            <tr>
                <th>Stall</th><th>Tenant</th><th>Payment No.</th><th>Date</th><th>Time</th><th>Status</th><th>Total</th><th>Payer</th><th>Collector</th>
            </tr>
            </thead>
            <tbody>
            ...
            @empty
                <tr><td colspan="9">No detailed records found in selected range.</td></tr>
            @endforelse
            </tbody>
        </table>
