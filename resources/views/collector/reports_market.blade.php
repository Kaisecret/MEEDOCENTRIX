...
<div data-server-rendered-page="collector_reports_market" data-page-title="Market Collector Reports" class="cr">
    <section class="cr-hero">
        <div>
            ...
            <p>Track assigned Public Market stall collections by day, week, month, or custom range.</p>
        </div>
    ...
    <section class="cr-card">
        <div class="cr-head"><h3>Detailed Collection Report</h3><div style="font-size:.8rem;color:#64748b;">Market stall payments (tenant, stall, payer, total)</div></div>
        <div class="cr-table-wrap">
            <table class="cr-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    @forelse($transactions as $row)
                        <tr>
                            ...
                            <td>
                                {{ $row['tenant_name'] }}
                                <div class="cr-sub">{{ $row['business_name'] }}</div>
                            </td>
                    ...
                    @empty
                        <tr><td colspan="9" class="cr-empty">No transactions found in selected range.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
